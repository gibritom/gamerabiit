...
export default class ScoreSystem {
  calculate(pathTilesUsed, elapsedMs, maxPathTiles, collectibleBonus = 0) {
    const unusedTiles = maxPathTiles - pathTilesUsed;
    ...
    return SCORE_BASE + tileBonus + timeBonus + collectibleBonus;
  }
}
