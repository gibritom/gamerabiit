...
| `systems/GridSystem` | Estado e lógica do grid | 1 ✓ |
...
| `ui/VictoryOverlay` | Modal de vitória, score e reinício | 2–4 ✓ |
...
Sprint 1 implementa modelo de estado interativo via `GridSystem`.
